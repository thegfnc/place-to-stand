...
const projects: Project[] = [
  {
    ...
    description:
      'Operations overhaul and digital customer portal for a regional logistics firm.',
  },
  {
    ...
    description:
      'E-commerce experience with storytelling product drops and loyalty program.',
  },
  {
    ...
    description:
      'Integrated LMS and marketing site for an education non-profit.',
  },
  {
    ...
    description:
      'Telehealth appointment scheduling and brand refresh for a healthcare network.',
  },
  {
    ...
    description:
      'Portfolio storytelling and investor relations hub for a venture studio.',
  },
  {
    title: 'Atlas Outdoor',
    ...
    description:
      'Immersive product catalog with AR previews for an outdoor equipment brand.',
  },
]
