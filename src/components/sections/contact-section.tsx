...
import { sendContact, type ContactActionResult } from "../../../app/actions/send-contact";
import {
  contactSchema,
    ...
    <AnimatedSection id="contact" className="flex flex-col gap-12">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="max-w-2xl text-lg text-ink/70">
          Tell us about the shift you want to make. We’ll follow up within one business day.
        </p>
      </div>
      <div className="grid gap-10 rounded-[40px] border border-ink/10 bg-white/80 p-10 shadow-xl backdrop-blur md:grid-cols-[1fr_1.2fr]">
        <div className="flex flex-col gap-6">
          ...
          <ul className="space-y-4 text-base text-ink/70">
            <li>• A quick discovery call to align on vision, scope, and success metrics.</li>
            <li>• A tailored proposal with timeline, investment, and team.</li>
            <li>• Clarity on how we partner—from discovery to launch to optimization.</li>
          </ul>
        </div>
