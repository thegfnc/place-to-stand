  ...
  return (
    ...
    >
      ...
      <h1 className='max-w-3xl font-headline text-5xl uppercase leading-tight tracking-[0.1em] text-ink md:text-6xl'>
        ...
        right tools and a solid foundation.
      </h1>
      <p className='max-w-2xl text-lg text-ink/80'>
        Place To Stand is the strategic, design, and development partner
        building experiences that help ambitious teams move the world forward.
      </p>
